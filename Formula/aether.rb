class Aether < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/connectchiragg/aether/releases/download/v0.5.2/aether-aarch64-apple-darwin.tar.gz"
      sha256 "52793a7c5fe2994bc4b1c5b5c025f3854546f40382175882196e015e5947f32e"
    else
      url "https://github.com/connectchiragg/aether/releases/download/v0.5.2/aether-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/connectchiragg/aether/releases/download/v0.5.2/aether-aarch64-unknown-linux-gnu.tar.gz"
      sha256 "11fb9653ba8f5a6b21f7a1e35e2dc3bcceb55fcfa2ecb007468083a364384a7e"
    else
      url "https://github.com/connectchiragg/aether/releases/download/v0.5.2/aether-x86_64-unknown-linux-gnu.tar.gz"
